                    ...
                    <div class="shop-widget">
                        ...
                        <form>
                            <div class="shop-widget-group">
                                <input type="text" placeholder="Min - 00"><input type="text" placeholder="Max - 5k">
                            </div>
                        ...
                        <div class="col">
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish">
                                        <i class="fas fa-heart"></i></button><a class="product-image"
                                        href="product-video.html"><img src="images/product/13.png" alt="product"></a>
                                </div>
                                <div class="product-content">
                                    <h6 class="product-name">
                                        <a href="product-video.html">Products Name</a>
                        ...
                        <div class="col">
                            <div class="product-card">
                                <div class="product-media">
                                    ...
                                    <button class="product-wish wish">
                                        <i class="fas fa-heart"></i></button><a class="product-image"
                                        href="product-video.html"><img src="images/product/12.png" alt="product"></a>
                                </div>
                                <div class="product-content">
                                    <h6 class="product-name">
                                        <a href="product-video.html">Products Name</a>
