    ...
    <section class="inner-section shop-part">
        <div class="container">
                ...
                <div class="col">
                    ...
                    <div class="product-card">
                        <div class="product-media">
                            ...
                            <div>
                                <button class="product-wish wish" data-bs-toggle="modal" data-bs-target="#login-modal">
            ...
            ><a href="product-video.html">(3)</a>
                ...
                <div class="col">
                    ...
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label">
                                <label class="label-text sale">popular</label><label class="view-label off">-10%</label>
                            </div>
                            <div>
                                <button class="product-wish wish" data-bs-toggle="modal" data-bs-target="#login-modal">
                                    <i class="fas fa-heart"></i>
            ...
            ><a href="product-video.html">(3)</a>
                ...
                <div class="col">
                    ...
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label">
                                <label class="label-text sale">new</label><!--v-if-->
                            </div>
                            <div>
                                <button class="product-wish wish" data-bs-toggle="modal" data-bs-target="#login-modal">
                                    <i class="fas fa-heart"></i>
            ...
            ><a href="product-video.html">(3)</a>
                ...
                <div class="col">
                    ...
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label">
                                <label class="label-text sale">popular</label><!--v-if-->
                            </div>
                            <div>
                                <button class="product-wish wish" data-bs-toggle="modal" data-bs-target="#login-modal">
                                    <i class="fas fa-heart"></i>
            ...
            ><a href="product-video.html">(3)</a>
                            ...
                            <h6 class="product-name">
                                <a href="/product/case-antec-mid-tower-argb-gaming-case" class="">Case Antec Mid Tower
                                    ARGB Gaming Case</a>
                            </h6>
                            <div>
                                <!-- //jodi modal ba single product page theke data ase.. tahole h3 design  -->
