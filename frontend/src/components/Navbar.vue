                    ...
                    <div class="navbar-content">
                        <ul class="navbar-list">
                            <li class="navbar-item dropdown">
                                <router-link :to="{name:'index'}" class="navbar-link" href="#">Home</router-link>
                            </li>
                            ...
                            <li class="navbar-item dropdown-megamenu">
                                <router-link class="navbar-link" :to="{name:'pages.shop'}">shop</router-link>
                            </li>
    
                            <li class="navbar-item dropdown-megamenu">
                                <router-link class="navbar-link" :to="{name:'pages.seller.list'}">Seller List</router-link>
                            </li>
                        </ul>
                    </div>
                </div>
