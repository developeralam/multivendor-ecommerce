  ...
  <div>
    <aside class="category-sidebar">
        <div class="category-header">
            ...
            <button class="category-close" @click="closeCategory"><i class="icofont-close"></i></button>
        </div>
    ...
    <aside class="nav-sidebar">
        <div class="nav-header">
            <a href="#"><img src="./assets/images/logo.png" alt="logo" /></a><button @click="closeSidebar" class="nav-close"><i
    ...
    <div class="mobile-menu">
        ...
        <button class="cate-btn" @click="showCategory" title="Category List">
            <i class="fas fa-list"></i><span>category</span>
        </button>
        <button class="cart-btn" @click="showCart" title="Cartlist">
